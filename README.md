...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/plot/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/plot)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/plot"
```
...
go get github.com/xxxxxx/plot

cd ${GOPATH}/src/github.com/xxxxxx/plot
...
> This is a copy of the example script available in the `cmd/example/plot` folder:

```go
package main

import "github.com/skeptycal/plot"
...
[issues]: (https://github.com/skeptycal/plot/issues)
[pr]: (https://github.com/skeptycal/plot/pulls)
